/* KOMA — Icônes SVG fines (traits 1.6px, 24×24)
   Usage : <i class="ic" data-icon="search"></i> — remplacé au chargement. */
(function () {
  var P = {
    ...
    'file-check': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 14l2 2 4-4"/>',
    'file-text': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M16 13H8"/><path d="M16 17H8"/>',
    ...
    eye: '<path d="M2.06 12.35a1 1 0 0 1 0-.7C3.42 8.12 7.4 5 12 5s8.58 3.12 9.94 6.65a1 1 0 0 1 0 .7C20.58 15.88 16.6 19 12 19s-8.58-3.12-9.94-6.65Z"/><circle cx="12" cy="12" r="3"/>',
  ...
  function inject() {
    ...
    for (var i = 0; i < nodes.length; i++) {
      ...
      if (P[name] && !el.querySelector('svg')) {
        el.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true">' + P[name] + '</svg>';
      }
    }
  }
